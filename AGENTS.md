...
- 涉及前端 React / 渐进 TypeScript 的细则见 `web-admin/AGENTS.md`，以该文件作为 Admin 前端 worker 的默认约束。
...
- Admin 企业认证中心一级菜单和菜单文档命名优先四字中文业务名；专有技术词可中英混合，例如 `LLM AI/Gateway`。不得新增抽象“中心/工作台/任务中心/快捷入口”式主入口，业务能力应沉到对象上下文、抽屉、工具栏、向导步骤或已有流程入口。
