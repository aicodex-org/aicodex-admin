...
func InitAPI() {
	...
	web.Router("/api/insight-admin-provider/handoff/status", &controllers.ApiController{}, "GET:GetInsightAdminProviderHandoffStatus")
	web.Router("/api/insight-admin-provider/handoff/config", &controllers.ApiController{}, "GET:GetInsightAdminProviderHandoffConfig;POST:SaveInsightAdminProviderHandoffConfig")
	web.Router("/api/insight-admin-provider/handoff/diagnostics", &controllers.ApiController{}, "POST:DiagnoseInsightAdminProviderHandoffConfig")
	web.Router("/api/insight-admin-provider/handoff/access-package", &controllers.ApiController{}, "POST:CreateInsightAdminProviderAccessPackage")
	web.Router("/api/insight-admin-provider/handoff/secure-grants", &controllers.ApiController{}, "POST:CreateInsightAdminProviderSecureHandoffGrant")
	web.Router("/api/insight-admin-provider/handoff/secure-grants/:grantId/status", &controllers.ApiController{}, "GET:GetInsightAdminProviderSecureHandoffGrantStatus")
	web.Router("/api/insight-admin-provider/handoff/secure-grants/:grantId/redeem", &controllers.ApiController{}, "POST:RedeemInsightAdminProviderSecureHandoffGrant")
	web.Router("/api/insight-admin-provider/handoff/secure-grants/:grantId/confirm", &controllers.ApiController{}, "POST:ConfirmInsightAdminProviderSecureHandoffGrant")
	web.Router("/api/insight-admin-provider/handoff/secure-grants/:grantId/fail", &controllers.ApiController{}, "POST:FailInsightAdminProviderSecureHandoffGrant")
	web.Router("/api/insight-admin-provider/handoff/secure-grants/:grantId/revoke", &controllers.ApiController{}, "POST:RevokeInsightAdminProviderSecureHandoffGrant")
	...
	web.Router("/api/organization-tree-operations/members", &controllers.ApiController{}, "GET:GetOrganizationTreeOperationsMembers")
	...
	web.Router("/api/organization-master-data-quality/directory", &controllers.ApiController{}, "GET:GetOrganizationDirectoryQuality")
	web.Router("/api/organization-master-data-quality/remediation-plan", &controllers.ApiController{}, "GET:GetOrganizationDirectoryRemediationPlan")
	web.Router("/api/organization-master-data-quality/remediation-action-drafts", &controllers.ApiController{}, "GET:GetOrganizationDirectoryRemediationActionDrafts")
	web.Router("/api/organization-master-data-quality/remediation-preflight", &controllers.ApiController{}, "GET:GetOrganizationDirectoryRemediationPreflights")
	...
	web.Router("/api/organization-master-data-quality/remediation-operator-note-readonly-audit-search", &controllers.ApiController{}, "GET:GetOrganizationDirectoryRemediationOperatorNoteReadonlyAuditSearch")
	...
	web.Router("/api/wecom-org-sync/dry-run-preview", &controllers.ApiController{}, "POST:DryRunWecomOrganizationSyncPreview")
	web.Router("/api/wecom-org-sync/dry-run-history", &controllers.ApiController{}, "GET:GetWecomOrganizationSyncDryRunHistories")
	web.Router("/api/wecom-org-sync/dry-run-history/:historyId", &controllers.ApiController{}, "GET:GetWecomOrganizationSyncDryRunHistory")
	...
	web.Router("/api/feishu-org-sync/handoff-evidence", &controllers.ApiController{}, "GET:GetFeishuOrganizationSyncHandoffEvidence")
