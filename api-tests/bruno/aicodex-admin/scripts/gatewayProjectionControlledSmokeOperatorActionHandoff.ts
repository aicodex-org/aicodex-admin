...
function ownerLimitsFromDecision(summary: LooseRecord = {}, fallbackStatus = "blocked") {
...
function doNotDispatchUntil(actionStatus, extra: LooseRecord = {}) {
  if (actionStatus === READY_ACTION_STATUS) {
...
function actionPackageMetadata(options: LooseRecord = {}) {
  return {
...
function baseResult(actionStatus, input: LooseRecord = {}, options: LooseRecord = {}, overrides: LooseRecord = {}) {
...
function aliasesFromDecision(summary: LooseRecord = {}) {
  return unique([
    summary.alias,
    summary.reason,
    summary.reasonAlias,
 ...
 */
function createGatewayProjectionControlledSmokeOperatorActionHandoff(input: LooseRecord = {}, options: LooseRecord = {}) {
