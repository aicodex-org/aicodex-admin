...
function ownerLimitsFromAction(summary: LooseRecord = {}, fallbackStatus = "blocked") {
...
function doNotDispatchUntil(readinessStatus, extra: LooseRecord = {}) {
  if (readinessStatus === READY_READINESS_STATUS) {
...
function readinessPackageMetadata(options: LooseRecord = {}) {
  return {
...
function readyChecksFor(readinessStatus, action: LooseRecord = {}) {
  if (readinessStatus !== READY_READINESS_STATUS) {
    return [];
  }
  return [
...
function evidenceReferencesFromAction(action: LooseRecord = {}) {
...
function baseResult(readinessStatus, input: LooseRecord = {}, options: LooseRecord = {}, overrides: LooseRecord = {}) {
...
function aliasesFromAction(summary: LooseRecord = {}) {
  return unique([
    summary.alias,
    summary.reason,
    summary.reasonAlias,
 ...
 */
function createGatewayProjectionControlledSmokeOperatorReadinessHandoff(input: LooseRecord = {}, options: LooseRecord = {}) {
