...
function handoffHint(handoff = {}, fallbackAlias) {
...
function defaultOwnerHandoffs(input = {}) {
...
function buildResult(status, reason, input, options = {}, extra = {}) {
...
function blockingAliasPrerequisites(input = {}) {
  const missing = [];
...
function createGatewayProjectionControlledSmokeReleaseRunbook(input = {}, options = {}) {
