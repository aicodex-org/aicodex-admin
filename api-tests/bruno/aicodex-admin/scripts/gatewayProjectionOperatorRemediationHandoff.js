...
function aliasesFromObject(value = {}) {
...
function collectHandoffAliases(value = {}) {
...
function collectInputAliases(input = {}) {
    const aliases = [
...
function createGatewayProjectionOperatorRemediationHandoff(input = {}, options = {}) {
