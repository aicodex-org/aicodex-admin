...
const { DEPLOY_STALE_ALIAS, NO_PUBLISHABLE_SUBJECTS_ALIAS, SANITIZATION_FAILED_ALIAS, evaluateGatewayProjectionObservabilityPreflight, } = require("./gatewayProjectionObservabilityPreflight");
...
function evaluateGatewayProjectionReadinessSummary(input = {}, options = {}) {
