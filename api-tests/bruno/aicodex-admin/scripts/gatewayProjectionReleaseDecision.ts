...
function evaluateGatewayProjectionReleaseDecision(input: LooseRecord = {}, options: LooseRecord = {}) {
...
function stableOwnerHandoffs(decisionResult: LooseRecord = {}) {
...
function createGatewayProjectionReleaseDecisionHandoff(input: LooseRecord = {}, options: LooseRecord = {}) {
