...
function countsSubjectAuthorized(value = {}) {
...
function buildBlockedResult(reason, blockers, evidenceAliases, options = {}) {
...
function buildFailClosed(status, reason, options = {}) {
  return {
    status,
    reason,
    sourceAlias: options.sourceAlias || "gateway_projection_remediation_result_evidence_handoff",
...
function buildReadyResult(evidenceAliases, options = {}) {
  return {
...
function collectEvidenceAliases(input = {}) {
  return unique([
...
function createGatewayProjectionRemediationResultEvidenceHandoff(input = {}, options = {}) {
