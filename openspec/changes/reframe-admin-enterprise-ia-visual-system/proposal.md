...
本 change 用 OpenSpec 固化新的路线方向：少入口、业务域导航、成熟企业控制台壳层、专业表格工具栏、对象上下文详情和可信证据链，避免后续 worker 继续把“企业级”误解为堆治理概念。
...
- 增加企业控制台视觉系统门禁：页面头、表格工具栏、状态标签、详情抽屉、空态/错误态、密度、移动端间距和 i18n 文案必须形成一致且专业的管理台体验。
...
- Affected future frontend areas: `web-admin/src/enterpriseNavigation.js`, `web-admin/src/ManagementPage.js`, enterprise identity overview/routes, object detail drawers, page headers, table toolbars, status tags, empty/error states and zh/en locale copy.
