# admin-external-service-http-client-lifetimes Specification

## Purpose
规定 Admin Azure ACS 邮件、GC Payment 与 FastSpring Pay/Notify 外呼的默认整体 timeout、局部 client 注入、终止语义和兼容边界。
