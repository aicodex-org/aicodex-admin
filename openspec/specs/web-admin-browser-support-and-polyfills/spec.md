# web-admin-browser-support-and-polyfills Specification

## Purpose
定义 `web-admin` 在 React 18 + Vite production 工具链下的浏览器支持真值、polyfill owner 边界，以及退役 CRA/IE polyfill 时必须保持的认证与验证契约。
## Requirements
