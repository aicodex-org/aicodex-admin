...
class App extends Component {
  ...
  shouldFlattenMenu() {
    ...
    const validMenuItems = [
      ...
      "/sysinfo", "/forms", "/syncers", "/wecom-org-sync", "/organization-sync-api-keys", "/webhooks", "/webhook-events", "/tickets", "/swagger", // Admin
    ];
  ...
  getSelectedMenuKeyForFlatMenu(uri) {
    ...
    } else if (uri.includes("/sysinfo") || uri.includes("/forms") || uri.includes("/syncers") || uri.includes("/wecom-org-sync") || uri.includes("/organization-sync-api-keys") || uri.includes("/webhooks") || uri.includes("/webhook-events") || uri.includes("/tickets")) {
