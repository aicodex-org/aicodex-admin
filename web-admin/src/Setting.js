...
export function getApiPaths() {
  ...
  res.push("feishu-org-sync/config", "feishu-org-sync/config/test", "feishu-org-sync/dry-run-history", "feishu-org-sync/runs");
  res.push("org-management-scope/current");
  res.push("organization-master-data-quality/directory", "organization-master-data-quality/remediation-plan", "organization-master-data-quality/remediation-action-drafts");
  res.push("gateway-projection/observability", "gateway-projection/run-readiness", "gateway-projection/ingestion-status", "gateway-projection/manual-publish", "gateway-projection/publish-attempts", "gateway-projection/publish-attempt-retention-readiness", "gateway-projection/publish-attempt-retention-cleanup-dry-run");
