...
export function getApiPaths() {
  ...
  res.push("feishu-org-sync/config", "feishu-org-sync/config/test", "feishu-org-sync/dry-run-history", "feishu-org-sync/user-binding-conflicts", "feishu-org-sync/handoff-evidence", "feishu-org-sync/runs");
  ...
  res.push("gateway-projection/observability", "gateway-projection/run-readiness", "gateway-projection/ingestion-status", "gateway-projection/manual-publish", "gateway-projection/publish-attempts", "gateway-projection/publish-attempt-retention-readiness", "gateway-projection/publish-attempt-retention-cleanup-dry-run", "gateway-projection/publish-attempt-retention-cleanup-execute-readiness", "gateway-projection/publish-attempt-retention-cleanup-approval-audit-trail");
