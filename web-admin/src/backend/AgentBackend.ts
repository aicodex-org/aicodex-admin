...
export function getAgents(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getAgent(owner: BackendValue, name: BackendValue) {
...
export function updateAgent(owner: BackendValue, name: BackendValue, agent: BackendValue) {
...
export function addAgent(agent: BackendValue) {
  const newAgent = Setting.deepCopy(agent);
...
export function deleteAgent(agent: BackendValue) {
  const newAgent = Setting.deepCopy(agent);
