...
export function getApplications(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getApplicationsByOrganization(owner: BackendValue, organization: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getApplication(owner: BackendValue, name: BackendValue) {
...
export function getUserApplication(owner: BackendValue, name: BackendValue) {
...
export function updateApplication(owner: BackendValue, name: BackendValue, application: BackendValue) {
...
export function addApplication(application: BackendValue) {
...
export function deleteApplication(application: BackendValue) {
  const newApplication = Setting.deepCopy(application);
...
export function getSamlMetadata(owner: BackendValue, name: BackendValue, enablePostBinding: BackendValue) {
