...
export function getForms(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getForm(owner: BackendValue, name: BackendValue) {
...
export function updateForm(owner: BackendValue, name: BackendValue, form: BackendValue) {
...
export function addForm(form: BackendValue) {
  const newForm = Setting.deepCopy(form);
...
export function deleteForm(form: BackendValue) {
  const newForm = Setting.deepCopy(form);
