...
export function getKeys(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getGlobalKeys(page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getKey(owner: BackendValue, name: BackendValue) {
...
export function updateKey(owner: BackendValue, name: BackendValue, key: BackendValue) {
...
export function addKey(key: BackendValue) {
  const newKey = Setting.deepCopy(key);
...
export function deleteKey(key: BackendValue) {
  const newKey = Setting.deepCopy(key);
