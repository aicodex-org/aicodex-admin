...
export function getLdaps(owner: BackendValue) {
...
export function getLdap(owner: BackendValue, name: BackendValue) {
...
export function addLdap(body: BackendValue) {
...
export function deleteLdap(body: BackendValue) {
...
export function updateLdap(body: BackendValue) {
...
export function getLdapUser(owner: BackendValue, name: BackendValue) {
...
export function syncUsers(owner: BackendValue, name: BackendValue, body: BackendValue) {
