...
export function MfaSetupInitiate(values: BackendValue) {
...
export function MfaSetupVerify(values: BackendValue) {
  const formData = new FormData();
  formData.append("owner", values.owner);
  formData.append("name", values.name);
  formData.append("mfaType", values.mfaType);
...
export function MfaSetupEnable(values: BackendValue) {
  const formData = new FormData();
  formData.append("mfaType", values.mfaType);
  formData.append("owner", values.owner);
  formData.append("name", values.name);
...
export function DeleteMfa(values: BackendValue) {
  const formData = new FormData();
  formData.append("owner", values.owner);
  formData.append("name", values.name);
...
export function SetPreferredMfa(values: BackendValue) {
  const formData = new FormData();
  formData.append("mfaType", values.mfaType);
  formData.append("owner", values.owner);
  formData.append("name", values.name);
