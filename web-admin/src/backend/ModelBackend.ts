...
export function getModels(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getModel(owner: BackendValue, name: BackendValue) {
...
export function updateModel(owner: BackendValue, name: BackendValue, model: BackendValue) {
...
export function addModel(model: BackendValue) {
  const newModel = Setting.deepCopy(model);
...
export function deleteModel(model: BackendValue) {
  const newModel = Setting.deepCopy(model);
