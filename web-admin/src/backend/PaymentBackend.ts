...
export function getPayments(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getPayment(owner: BackendValue, name: BackendValue) {
...
export function updatePayment(owner: BackendValue, name: BackendValue, payment: BackendValue) {
...
export function addPayment(payment: BackendValue) {
  const newPayment = Setting.deepCopy(payment);
...
export function deletePayment(payment: BackendValue) {
  const newPayment = Setting.deepCopy(payment);
...
export function invoicePayment(owner: BackendValue, name: BackendValue) {
...
export function notifyPayment(owner: BackendValue, name: BackendValue) {
