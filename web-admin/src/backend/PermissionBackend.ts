...
export function getPermissions(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getPermission(owner: BackendValue, name: BackendValue) {
...
export function updatePermission(owner: BackendValue, name: BackendValue, permission: BackendValue) {
...
export function addPermission(permission: BackendValue) {
  const newPermission = Setting.deepCopy(permission);
...
export function deletePermission(permission: BackendValue) {
  const newPermission = Setting.deepCopy(permission);
