...
export function getPlans(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getPlan(owner: BackendValue, name: BackendValue, includeOption: BackendValue = false) {
...
export function updatePlan(owner: BackendValue, name: BackendValue, plan: BackendValue) {
...
export function addPlan(plan: BackendValue) {
  const newPlan = Setting.deepCopy(plan);
...
export function deletePlan(plan: BackendValue) {
  const newPlan = Setting.deepCopy(plan);
