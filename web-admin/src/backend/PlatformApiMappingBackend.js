...
export function getOrganizationDirectoryRemediationApprovalPacketAudit(organization, options = {}) {
  const query = new URLSearchParams();
  query.set("organization", organization || "");
...
export function getOrganizationDirectoryRemediationApprovalPacketOperatorNotes(organization, options = {}) {
  const query = new URLSearchParams();
  query.set("organization", organization || "");
  if (options.noteId) {
...
export function getOrganizationDirectoryRemediationOperatorNoteReadonlyAuditSearch(organization, options = {}) {
  const query = new URLSearchParams();
  query.set("organization", organization || "");
  if (options.searchId) {
...
export function getGatewayProjectionPublishAttemptCleanupApprovalPolicyReadiness(organization, options = {}) {
  const query = new URLSearchParams();
  query.set("organization", organization || "");
  if (options.source) {
    query.set("source", options.source);
...
export function getGatewayProjectionPublishAttemptCleanupExecutionGateOwnerBoundaryPreflight(organization, options = {}) {
  const query = new URLSearchParams();
  query.set("organization", organization || "");
  if (options.source) {
    query.set("source", options.source);
