...
export function getProducts(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getProduct(owner: BackendValue, name: BackendValue) {
...
export function updateProduct(owner: BackendValue, name: BackendValue, product: BackendValue) {
...
export function addProduct(product: BackendValue) {
  const newProduct = Setting.deepCopy(product);
...
export function deleteProduct(product: BackendValue) {
  const newProduct = Setting.deepCopy(product);
