...
export function getProviders(owner: BackendValue = "", page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getGlobalProviders(page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getProvider(owner: BackendValue, name: BackendValue) {
...
export function updateProvider(owner: BackendValue, name: BackendValue, provider: BackendValue) {
...
export function addProvider(provider: BackendValue) {
  const newProvider = Setting.deepCopy(provider);
...
export function deleteProvider(provider: BackendValue) {
  const newProvider = Setting.deepCopy(provider);
