...
export function getRoles(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getRole(owner: BackendValue, name: BackendValue) {
...
export function updateRole(owner: BackendValue, name: BackendValue, role: BackendValue) {
...
export function addRole(role: BackendValue) {
  const newRole = Setting.deepCopy(role);
...
export function deleteRole(role: BackendValue) {
  const newRole = Setting.deepCopy(role);
