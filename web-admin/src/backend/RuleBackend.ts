...
export function getRules(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getRule(owner: BackendValue, name: BackendValue) {
...
export function addRule(rule: BackendValue) {
...
export function updateRule(owner: BackendValue, name: BackendValue, rule: BackendValue) {
...
export function deleteRule(rule: BackendValue) {
