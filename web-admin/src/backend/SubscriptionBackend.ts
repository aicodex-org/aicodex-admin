...
export function getSubscriptions(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getSubscription(owner: BackendValue, name: BackendValue) {
...
export function updateSubscription(owner: BackendValue, name: BackendValue, subscription: BackendValue) {
...
export function addSubscription(subscription: BackendValue) {
  const newSubscription = Setting.deepCopy(subscription);
...
export function deleteSubscription(subscription: BackendValue) {
  const newSubscription = Setting.deepCopy(subscription);
