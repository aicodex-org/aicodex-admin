...
export function getTickets(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getTicket(owner: BackendValue, name: BackendValue) {
...
export function updateTicket(owner: BackendValue, name: BackendValue, ticket: BackendValue) {
...
export function addTicket(ticket: BackendValue) {
  const newTicket = Setting.deepCopy(ticket);
...
export function deleteTicket(ticket: BackendValue) {
  const newTicket = Setting.deepCopy(ticket);
...
export function addTicketMessage(owner: BackendValue, name: BackendValue, message: BackendValue) {
