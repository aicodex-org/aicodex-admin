...
export function getTokens(owner: BackendValue, organization: BackendValue = "", page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getToken(owner: BackendValue, name: BackendValue) {
...
export function updateToken(owner: BackendValue, name: BackendValue, token: BackendValue) {
...
export function addToken(token: BackendValue) {
  const newToken = Setting.deepCopy(token);
...
export function deleteToken(token: BackendValue) {
  const newToken = Setting.deepCopy(token);
