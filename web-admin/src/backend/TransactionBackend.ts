...
export function getTransactions(owner: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getTransaction(owner: BackendValue, name: BackendValue) {
...
export function updateTransaction(owner: BackendValue, name: BackendValue, transaction: BackendValue) {
...
export function addTransaction(transaction: BackendValue) {
  const newTransaction = Setting.deepCopy(transaction);
...
export function deleteTransaction(transaction: BackendValue) {
  const newTransaction = Setting.deepCopy(transaction);
