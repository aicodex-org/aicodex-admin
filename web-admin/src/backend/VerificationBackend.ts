...
export function getVerifications(owner: BackendValue, organization: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getVerification(owner: BackendValue, name: BackendValue) {
