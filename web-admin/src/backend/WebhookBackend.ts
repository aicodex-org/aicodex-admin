...
export function getWebhooks(owner: BackendValue, organization: BackendValue, page: BackendValue = "", pageSize: BackendValue = "", field: BackendValue = "", value: BackendValue = "", sortField: BackendValue = "", sortOrder: BackendValue = "") {
...
export function getWebhook(owner: BackendValue, name: BackendValue) {
...
export function updateWebhook(owner: BackendValue, name: BackendValue, webhook: BackendValue) {
...
export function addWebhook(webhook: BackendValue) {
  const newWebhook = Setting.deepCopy(webhook);
...
export function deleteWebhook(webhook: BackendValue) {
  const newWebhook = Setting.deepCopy(webhook);
