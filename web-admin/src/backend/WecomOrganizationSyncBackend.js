...
export function getWecomOrganizationSyncConfig(organization) {
...
export function saveWecomOrganizationSyncConfig(config) {
...
export function testWecomOrganizationSyncConfig(config) {
  const newConfig = Setting.deepCopy(config);
...
export function getWecomOrganizationSyncRuns(organization, page = "", pageSize = "", field = "", value = "", sortField = "", sortOrder = "") {
...
export function getWecomOrganizationSyncRun(organization, runId) {
