  ...
  const groups = [
    {
      ...
      children: [
        ...
        {key: "/identity-assets", label: i18next.t("general:Identity Asset Relationships"), to: "/identity-assets", matchPrefixes: ["/identity-assets"]},
        {key: "/access-wizard", label: i18next.t("general:Access Preflight Center"), to: "/access-wizard", matchPrefixes: ["/access-wizard"]},
